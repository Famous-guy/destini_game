...
class StoryBrain {
  ...
  void nextStory(int next) {
    if (next == 1 && _storyNumber == 0) {
      _storyNumber = 2;
    } else if (next == 2 && _storyNumber == 0) {
      _storyNumber = 1;
    } else if (next == 1 && _storyNumber == 1) {
      _storyNumber = 2;
    } else if (next == 2 && _storyNumber == 1) {
      _storyNumber = 3;
    } else if (next == 1 && _storyNumber == 2) {
      next = 5;
    } else if (next == 2 && _storyNumber == 2) {
      _storyNumber = 4;
